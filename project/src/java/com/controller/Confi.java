 ...
 * @author legend
 */
public class Confi extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {System.out.println(btn);
            stmt = DBController.getPreStmt("select * from buy_pac where pac_id=?");
        ...
        while(rs.next()){
            ...
            PreparedStatement stm;
                ...
                stm = DBController.getPreStmt("UPDATE buy_pac SET confi = ? WHERE pac_id = ?");
